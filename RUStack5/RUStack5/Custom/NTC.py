...
__pdoc__['NTC.set_gain']=False
__pdoc__['NTC.set_rate']=False
__pdoc__['NTC.read_ads1100']=False
__pdoc__['NTC.read_temp']=False
__pdoc__['NTC.adc_value']=False
__pdoc__['NTC.voltage']=False
...
class NTC():
    ...
    def __init__(self,RUStack_parent):
        ...
        self.RATE_TABLE = (
            (8,b">ADC.Configure(RATE=8)"),
            (16,b">ADC.Configure(RATE=16)"),
            (32,b">ADC.Configure(RATE=32)"),
            (128,b">ADC.Configure(RATE=128)"))
        self.rate=1
        self.gain=8
        self._voltage=0
        self._temperature=0
